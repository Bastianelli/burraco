...
/**
 * The persistence interface for the round service.
 *
 * <p>
 ...
 */
@ProviderType
public interface RoundPersistence extends BasePersistence<Round> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RoundUtil} to access the round persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<Round> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Round> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Round> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Round>
			orderByComparator);
	 ...
	 * @return the matching rounds
	 */
	public java.util.List<Round> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching rounds
	 */
	public java.util.List<Round> findByUuid_C(
	 ...
	 * @return the matching rounds
	 */
	public java.util.List<Round> findByGameId(long gameId);
	 ...
	 * @return the range of matching rounds
	 */
	public java.util.List<Round> findByGameId(long gameId, int start, int end);
	 ...
	 * @return the ordered range of matching rounds
	 */
	public java.util.List<Round> findByGameId(
	 ...
	 */
	public void cacheResult(java.util.List<Round> rounds);
	 ...
	 * @return the rounds
	 */
	public java.util.List<Round> findAll();
	 ...
	 */
	public java.util.List<Round> findAll(int start, int end);
